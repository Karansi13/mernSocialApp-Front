...
const UserProfile = () => {
  ...
  useEffect(() => {
    ...
    if (user) {
      user.followers.forEach((item) => {  /// reload krne se front end follow hi show krrha tha to isko thik krne ke liye for loop lagaenge check krne ke liye ki user ki id  exist krti h ki nhii
        if (item._id === me._id) {
          setFollowing(true);
        } else {
          setFollowing(false);
      ...
      <div className="accountright">
        {user && (
          <>
            ...
            <Typography variant="h5" style={{color: "white"}} >{user.name}</Typography>

            <div>
              <button onClick={() => setFollowersToggle(!followersToggle)}>
                <Typography style={{color: "black"}}>Followers</Typography>
              </button>
            ...
            <div>
              <button onClick={() => setFollowingToggle(!followingToggle)}>
                <Typography style={{color: "black"}}>Following</Typography>
              </button>
